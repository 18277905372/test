package com.liang.utils.result;
...
import static com.liang.utils.result.ResultCode.UNAUTHORIZED;
...
public class Result implements Serializable {
    ...
    public static Result unAuth() {
        return new Result(UNAUTHORIZED.getCode(), UNAUTHORIZED.getMessage(), "");
    }
    ...
    public static Result error(Object code,Object msg) {
        return new Result((Long) code, (String) msg, msg);
    }
    ...
    public static Result build(Integer status, String msg) {
        return new Result(UNAUTHORIZED.getCode(), msg, null);
    }
